  ...
  class o {
    constructor(t) {
      ...
      (this.hash = this.randomHash()),
        (this.settings = Object.assign(Object.assign(Object.assign({}, a.Modal.Default), a.Carousel.Default), { interval: !1, target: '[data-toggle="lightbox"]', gallery: "", size: "fullscreen", constrain: !0 })),
      ...
      const t = document.createElement("template"),
        ...
        s = this.sources
          .map((t, s) => {
            ...
            const n = this.settings.constrain ? "" : "h-100 w-100",
            ...
            return '\n\t\t\t\t<div class="carousel-item '
              .concat(s ? "" : "active", '" style="height: 100vh">\n\t\t\t\t\t')
        ...
        i =
          this.sources.length < 2
            ...
            : '\n\t\t\t<button id="#lightboxCarousel-'
                .concat(this.hash, '-prev" class="carousel-control carousel-control-prev h-100 m-auto" type="button" data-bs-target="#lightboxCarousel-')
                .concat(
                  this.hash,
                  '" data-bs-slide="prev">\n\t\t\t\t<span class="carousel-control-prev-icon" aria-hidden="true"></span>\n\t\t\t\t<span class="visually-hidden">Previous</span>\n\t\t\t</button>\n\t\t\t<button id="#lightboxCarousel-'
                )
                .concat(this.hash, '-next" class="carousel-control carousel-control-next h-100 m-auto" type="button" data-bs-target="#lightboxCarousel-')
    ...
    createModal() {
      const t = document.createElement("template"),
        e = '\n\t\t\t<div class="modal lightbox fade" id="lightboxModal-'
          ...
          .concat(
            this.settings.size,
            '">\n\t\t\t\t\t<div class="modal-content border-0" style="background-color: rgba(0, 0, 0, 0.8)">\n\t\t\t\t\t\t<div class="modal-body p-0">\n\t\t\t\t\t\t\t<button type="button" class="btn-close position-absolute p-3 fs-4" data-bs-dismiss="modal" aria-label="Close" style="z-index: 2; background: none; top: 0; right: 0">'
          )
          .concat(
